...
func _enter_tree():
	...
	#add_autoload_singleton(TWITCH_SERVICE_AUTOLOAD_NAME, "res://addons/ridiculous_stream/libraries/twitcher/twitch_service.gd");
	add_autoload_singleton(HTTP_CLIENT_MANAGER_AUTOLOAD_NAME, "res://addons/ridiculous_stream/libraries/twitcher/communication/http_client_manager.gd");
