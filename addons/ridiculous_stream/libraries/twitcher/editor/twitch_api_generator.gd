...
func _generate_repositories():
	...
	var template_parameter_optional = template.read_template_file("res://addons/ridiculous_stream/libraries/twitcher/editor/template_method_parameters_optional.txt");
	var template_body_optional = template.read_template_file("res://addons/ridiculous_stream/libraries/twitcher/editor/template_method_body_optional.txt");
	var gdscript_code := ""
